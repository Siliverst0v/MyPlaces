...
//  MyPlaces
//
//  Created by Анатолий Силиверстов on 29.03.2022.
//
...
class MapManager {
    ...
    private var directonsArray: [MKDirections] = []
    ...
    func resetMapView(withNew directions: MKDirections, mapView: MKMapView) {
        ...
        directonsArray.append(directions)
        let _ = directonsArray.map { $0.cancel() }
        directonsArray.removeAll()
    }
